/* empty css                      */import{a as u,S as m,i as l}from"./assets/vendor-DvfmeZXB.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();const g="53375029-d8153a1ccdcfd643a785188b2",y="https://pixabay.com/api/";u.defaults.baseURL=y;async function h(a){const r={key:g,q:a,image_type:"photo",orientation:"horizontal",safesearch:!0};return(await u.get("",{params:r})).data}const p=document.querySelector(".gallery"),i=document.querySelector(".loader"),L=new m(".gallery a",{captionsData:"alt",captionDelay:250});function b(a){const r=a.map(({largeImageURL:s,webformatURL:o,tags:e,likes:t,views:n,comments:d,downloads:f})=>`
